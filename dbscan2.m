...
%
% Output:
%       clustLabel - final label vector (0 is assigned to noise or border points)
...
function plot_kdist(x, MinPts, distance)
...
kdist = sort(kdist, 'ascend');
figure;
plot(kdist); 
xlabel('points sorted according to distance of 4th nearest neighbors');
ylabel('4th nearest neighbors distance');
